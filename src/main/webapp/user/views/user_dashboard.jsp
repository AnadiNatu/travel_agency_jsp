...
<section class="ee-section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-lg-4">
        <div class="ee-card">
          <div class="ee-card__body text-center" style="padding:2.5rem 1.5rem;">

            <div style="width:120px;height:120px;border-radius:50%;background:var(--gold);
                        display:flex;align-items:center;justify-content:center;
                        margin:0 auto 1.5rem;font-size:3rem;color:var(--ocean);">
            ...
            <div class="d-flex flex-column gap-2">
              <a href="<%=request.getContextPath()%>/user/views/edit_user_details.jsp"
                 class="btn-ee btn-ee--ocean btn-ee--sm w-100 justify-content-center">
                <i class="bi bi-pencil"></i> Edit Profile
              </a>

              <a href="<%=request.getContextPath()%>/user/views/booking_trip.jsp"
                 class="btn-ee btn-ee--primary btn-ee--sm w-100 justify-content-center">
                ...
                <table class="ee-table">
                  ...
                  %>
                    ...
                    <tr>
                      ...
                      <td>
                        <%= bookings.getString("city") %>,
                        <%= bookings.getString("country") %>
                      </td>

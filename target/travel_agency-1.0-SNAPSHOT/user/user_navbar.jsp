...
<nav class="ee-nav">
  ...
  <ul class="ee-nav__links">
    ...
    <li>
      <a href="<%=request.getContextPath()%>/user/views/user_dashboard.jsp">
        <i class="bi bi-house"></i> Dashboard
      </a>
    </li>

    <li>
      <a href="<%=request.getContextPath()%>/user/views/tour.jsp">
        <i class="bi bi-map"></i> Tours
      </a>
    </li>

    <li>
      <a href="<%=request.getContextPath()%>/user/views/blog.jsp">
        <i class="bi bi-journal-text"></i> Blog
      </a>
    </li>

    <li>
      <a href="<%=request.getContextPath()%>/user/views/contact.jsp">
    ...
    <li style="margin-left:auto;">
      <a href="<%=request.getContextPath()%>/user/views/edit_user_details.jsp" style="color:var(--gold-light);">
        ...
        <%= session.getAttribute("authUser") != null ? session.getAttribute("authUser") : "User" %>
      </a>
    </li>
